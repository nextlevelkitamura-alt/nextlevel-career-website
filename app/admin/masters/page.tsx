...
import { Building2, Settings2, ArrowRight } from "lucide-react";
    ...
    return (
        <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-6">
                ...
                {/* Options Master */}
                <Link href="/admin/masters/options" className="block group">
                    <div className="bg-white p-8 rounded-xl shadow-sm border border-slate-200 group-hover:border-primary-200 group-hover:shadow-md transition-all h-full">
                        <div className="flex items-center justify-between mb-4">
                        ...
                        <h2 className="text-lg font-bold text-slate-900 mb-2">選択肢テンプレート管理</h2>
                        <p className="text-sm text-slate-500">
                            「勤務時間」「休日休暇」「選考プロセス」などで使用する定型文テンプレートを管理します。
                        </p>
                    </div>
                </Link>
            </div>
