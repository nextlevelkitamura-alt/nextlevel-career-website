                    ...
                    <div className="lg:col-span-2 space-y-4">
                        ...
                        <div className="bg-white rounded-xl p-5 md:p-8 shadow-sm border border-slate-200">
                            <div className="flex flex-wrap items-center gap-2 mb-3">
                                <span className={cn("px-2.5 py-0.5 rounded text-xs font-bold shadow-sm", getEmploymentTypeStyle(job.type))}>
                                    {job.type}
                                </span>
                                <span className="px-2 py-0.5 rounded-full text-[11px] font-medium bg-slate-100 text-slate-600 border border-slate-200">
                                    {job.category}
                                </span>
                                <span className="text-[10px] text-slate-400 font-mono ml-auto">ID: {job.job_code}</span>
                            </div>
                            ...
                            <div className="bg-slate-50 rounded-lg border border-slate-200 p-3 space-y-1.5 text-sm">
                                ...
                                {job.nearest_station && (
                                    <div className="flex items-center text-slate-700">
                                        <span className="w-3.5 h-3.5 mr-1.5 text-slate-400 flex-shrink-0 text-center text-[10px]">🚃</span>
                                        {job.nearest_station}
                                    </div>
                                )}
                                <div className="flex items-center text-slate-900 font-bold text-sm">
                                    <Banknote className="w-3.5 h-3.5 mr-1.5 text-slate-400 flex-shrink-0" />
                        ...
                        <div className="bg-white rounded-xl shadow-sm border border-slate-100 overflow-hidden">
                            <div className="px-5 md:px-8 divide-y divide-slate-200 text-sm">
                                ...
                                {/* 対象となる方（応募資格） */}
                                <div className="py-4">
                                    <h3 className="text-base font-bold text-slate-900 mb-1">対象となる方</h3>
                                ...
                                {/* 仕事内容 */}
                                <div className="py-4">
                                    <h3 className="text-base font-bold text-slate-900 mb-1">仕事内容</h3>
                                ...
                                {(job.attire_type || job.hair_style || job.attire || dispatchDetails?.nail_policy) && (
                                    <div className="py-4">
                                        <h3 className="text-base font-bold text-slate-900 mb-1">服装・身だしなみ</h3>
                                ...
                                {job.benefits && (() => {
                                    ...
                                    return (
                                        <div className="py-4">
                                            <h3 className="text-base font-bold text-slate-900 mb-1">福利厚生</h3>
                                            <div className="text-slate-700 leading-snug">
                                                {(() => {
                                                    try {
                                                        const items = JSON.parse(job.benefits);
                                                        ...
                                                        return <p className="whitespace-pre-line">{job.benefits}</p>;
                                                    } catch {
                                                        return <p className="whitespace-pre-line">{job.benefits}</p>;
                                                    }
                                                })()}
                                ...
                                {isFulltime && fulltimeDetails && (fulltimeDetails.company_overview || fulltimeDetails.industry) && (
                                    <div className="py-4">
                                        <h3 className="text-base font-bold text-slate-900 mb-1">企業情報</h3>
                                        <div className="space-y-2 text-slate-700">
                                            ...
                                            {fulltimeDetails.company_overview && (
                                                <p className="whitespace-pre-line">{fulltimeDetails.company_overview}</p>
                                            )}
                                        </div>
                                    </div>
                                )}
                                ...
                                {dispatchDetails?.general_notes && (
                                    <div className="py-4">
                                        <h3 className="text-base font-bold text-slate-900 mb-1">備考</h3>
                                ...
                                {job.selection_process && (
                                    <div className="py-4">
                                        <h3 className="text-base font-bold text-slate-900 mb-1">応募方法</h3>
                                        <div className="text-slate-700">
                                            {(() => {
                                                try {
