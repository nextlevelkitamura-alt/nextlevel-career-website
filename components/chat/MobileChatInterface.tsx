...
import { Send, Image as ImageIcon, Loader2, X, Phone, Home } from "lucide-react";
    ...
    return (
        <div className="fixed inset-0 z-[60] bg-slate-50 flex flex-col">
            ...
            <div className="flex items-center justify-between p-3 bg-white border-b border-slate-200 shadow-sm shrink-0 h-16">
                ...
                {/* Right: Phone Button */}
                <a href="tel:0120-000-000" className="flex flex-col items-center justify-center text-primary-600 hover:text-primary-700 bg-primary-50 p-2 rounded-lg">
